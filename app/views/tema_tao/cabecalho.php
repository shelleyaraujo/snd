...
<div class="icones-topo">
   <div class="i-menu" onclick="abre_m_cat()"></div>
 	<!--<div class="i-tel" onclick="atelc()"></div>
 	<div class="i-whats" onclick="awhatc()"></div>
 	<div class="i-busca" onclick="a_busca()"></div>
 	<div class="i-contato"><a href="/?contato=1"></a></div>-->
  <div class="i-carrinho"><a href="<?php echo myUrl() . "pedidos/carrinho" ?>">Car</a></div>
  <div class="i-login"><a href="<?php echo myUrl() . "tao" ?>">Lo</a></div>
</div>
...
<header>
    ...
    <div class="cnt-topo1">
       <div class="topo1 row">
         <div class="twelve columns b">
            <nav id="nav-inst"><?php echo $menu_institucional; ?></nav>

            <div class="htels" itemscope itemtype="http://schema.org/EducationalOrganization">
               <?php echo $telefones; ?> 			
           </div>
           <div class="hsociais">
  ...
  <div class="five columns b">
      <form id='form-busca' action="<?php echo myUrl('pesquisa/index/1/1') ?>" method='post' onsubmit="return toSubmit();" >
        <label class="busca-texto">
          <input type="text" name="busca" id="palavra_a_buscar" placeholder="Buscar por:">
      </label>
...
<div class="five columns c">
 <!--<?php echo "<a href='" . myUrl() . "institucional/index/0/47/0/0/fale-conosco' class='fale-conosco'>Fale Conosco</a>" ?> -->  
