...
<body>
 ...
 <div class="painel">
   ...
   <div class="p-b">
    ...
    <form id="form-rodape" method="POST" action="<?php echo myUrl('tao/editar_rodape/') ?>">
      ...
      <a href="javascript:void(0)" id="add_facebook" class="button-secundario">&nbsp;Digite a url do site</a>
    ...
    <textarea name="enderecos" id="enderecos" maxlength="500"><?php echo $enderecos ?></textarea>
    <input type="hidden" name="update_rodape" value="update">
...
<div class="p-c">
 <div class="logotipo-rodape">
  ...
  <div id="uploader">
    ...
    <img id="picture" src="../../imagens/logo-rodape.png" />
    <div id="loader"></div>
...
<?php include_once "uploadlogorodapejs.php"; ?>
...
<script>
  ...
  function update_rodape() {
    ...
    xhr.open('POST', '<?php echo myUrl('tao/update_rodape/') ?>');
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.onload = function() {
      if (xhr.status === 200) {
       window.location.replace("editar_rodape/" + descricao);
     }
