 ...
 <body>
 	...
 	<div class="painel"> 
      ...
      <h1>Imóveis Akugar</h1>

      <form id="cadastrar-modulo" method="POST" onsubmit="return verificar()" action="<?php echo myUrl('tao/imoveis_alugar/') ?>">
      ...
      <div class="modulos"> 
       ...
       <div class="cnt-botoes">
        <a class="button-vazado" href="<?php echo myUrl("tao/imoveis_comprar/"); ?>">Imóveis para Comprar</a>
