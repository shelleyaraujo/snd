...
<body>
 ...
 <div class="painel">
  ...
  <div class="p-b">
    ...
    <a href="javascript:void(0)" onclick="adicionar_item_modulo('<?php echo $_GET["idmodulo"]; ?>','<?php echo $_GET["modulo"]; ?>')" class='button'>Inserir Item</a>
...
function excluir_item(id) {
  ...
  if (r == true) {
    ...
    var imagem = imagem,
    xhr = new XMLHttpRequest();
    xhr.open('POST', '<?php echo myUrl('tao/excluir_item_institucional/') ?>');
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.onload = function() {
      if (xhr.status === 200) {
