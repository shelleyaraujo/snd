 ...
 <body>
 	...
 	<div class="painel"> 
 		...
 		<div class="p-b">
          <h1>Página apenas para apresentar Categorias</h1>

       <input type="hidden" id="origem" value="0">
    <input type="hidden" id="destino" value="0">

    
 			<form id="cadastrar-modulo" method="POST" onsubmit="return verificar()" action="<?php echo myUrl('tao/categorias/') ?>">
 		...
 		<div class="p-c"> 
 			<i><strong>Atenção:</strong></i> <br>Quando desejar apresentar outras páginas dentro de uma categoria como se fosse subcategoria utilize este módulo. 
 		</div>
 	</div>
