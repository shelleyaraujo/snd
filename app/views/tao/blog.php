 ...
 <body>
    ...
    <input type="hidden" id="destino" value="0">
      ...
      <form id="cadastrar-modulo" method="POST" onsubmit="return verificar()" action="<?php echo myUrl('tao/blog/') ?>">
     ...
     <div class="nt-botoes">
      <a class="button-vazado" href="<?php echo myUrl("tao/posts_home/"); ?>" class="xbutton">Itens na Home</a>
    </div>
