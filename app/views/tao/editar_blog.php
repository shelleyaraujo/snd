...
<body>
 ...
 <div class="painel">
  ...
  <div class="p-b">
   ...
   <form id="form-cabecalho" method="POST" action="<?php echo myUrl('tao/editar_blog/?idconteudo=' . $_GET["idconteudo"]) ?>">
    <label>Titulo:</label>
    <input type="text" name="titulo" value="<?php echo $titulo ?>">

   
    <div class="cnt-botoes">
      <a class="button-vazado" href="javascript:void(0)" onclick="open_inserir_video()">Inserir Videos</a>
      <a class="button-vazado" href="javascript:void(0)" onclick="open_upload_imagem()">Inserir Imagem</a>
      <div class="button-vazadox visualizar-na-home"><?php echo $post_na_home; ?>Visualizar na Home</div>
    </div>
