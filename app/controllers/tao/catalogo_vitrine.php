...
function _catalogo_vitrine() {

	$core=new Core(); 
	$data = $core->getData($id="1",$idcat="0");

    $itens_catalogo = $data['itens_catalogo'];
	$data["catalogo"] = MontaCatalogoVitrine($itens_catalogo);

	View::do_dump(VIEW_PATH. 'tao/catalogo_vitrine.php',$data);

}

function MontaCatalogoVitrine($itens_catalogo)
{
  ...
  $drCatalogos = $Catalogos->readItensVitrine($itens_catalogo, $x, $y, "titulo");
