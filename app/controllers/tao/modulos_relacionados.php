...
function _modulos_relacionados() { 
  ...
  for ($i=0; $i <= count($dr_modulos); $i++) {
    ...
    if(isset($dr_modulos[$i][0])) {
      ...
      if($dr_modulos[$i][0] > 0) {
       ...
       $r .= "<li>";
       $r .= "<input ".$checked." id='relacionado". $dr_modulos[$i][0] ."' type='checkbox' name='relacionado' value='0' onclick=set_relacionado(".$dr_modulos[$i][0].")>";
       $r .= $dr_modulos[$i][3];
       $r .= "</li>";
       $checked = "";
     }
