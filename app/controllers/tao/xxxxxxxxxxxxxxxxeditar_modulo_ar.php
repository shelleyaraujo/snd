...
foreach ($dr_sliders as $row_sliders[]) {
  if($row_sliders[$iii][0] != "#p#") {
    ...
    $sliders .= "<li><input " . $c . " name='id_sliders[]' type='checkbox' value='".$row_sliders[$iii][0]  ."'><img src='". myUrl("ImageImagens.php?w=80&dir=sliders&imagem=" . $row_sliders[$iii][4]) . "'></li>";
  }
}
  $iii++;
}
...
View::do_dump(VIEW_PATH. 'tao/editar_modulo_ar.php',$data);
