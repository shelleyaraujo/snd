...
function _menu_editar_itens() {
	...
	$data["modulos"]  = "<div class='xxxxx'>";
	$data["modulos"]  .= get_menu($modulo,"0");
	$data["modulos"]  .= "</div>";

	if(isset($_POST["pesquisar"])) {
		$data["modulos"]  = "<div class='xxxxx'>";
		$data["modulos"] .= get_menu_itens_busca($_POST["pesquisa"], $modulo);
		$data["modulos"] .= "</div>";
	} 
...
function get_menu($modulo,$idcat) {
	...
	$dr_menu = $o_menu->get_menu_itens_todos($idcat,"ordem");
	return $dr_menu; 
}
