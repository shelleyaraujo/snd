  ...
  for ($i=0; $i <= count($drimoveis); $i++) {
    ...
    if(isset($drimoveis[$i][0])) {
     ...
     if($drimoveis[$i][0] == "#p#") {
      ...
      $pg = str_replace("?controle=page&acao=open&id=",myUrl("imoveiscomprar/index/"),$drimoveis[$i][1]);
