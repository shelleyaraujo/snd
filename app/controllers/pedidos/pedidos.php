...
die("xxx");
  ...
  $r = "<a href='./tao' class='button'>Painel Administrativo</a>";  
  ...
  foreach ($drPedidos as $row[])
  {
    if ($row[$i][0] == "#p#") {
      ...
      $r .= "<td>";
      $r .= "<a href='?controle=PedidoPedidos&acao=open&idpedido=". $row[$i][0] . "'><span style='color:skyblue'>" . $dma->format('d/m/Y h:i:s') . "</span></a>";
      $r .= "</td>";
